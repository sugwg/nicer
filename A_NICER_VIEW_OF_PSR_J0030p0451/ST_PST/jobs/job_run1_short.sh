...
srun python main_run1_short.py > out_run1_short 2> err_run1_short

cp run1* out_run1_short err_run1_short $HOME/NICER_analyses/J0030_ST_PST/.
#end of job file
